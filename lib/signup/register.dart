              ...
              child: Column(
                children: [
                  Text(
                    "Register",
                    style:
                        TextStyle(fontSize: 32, color: Colors.indigo.shade900),
                  ),
                  // SizedBox(height: 3,),
                  Text(
                    "Create Your Account",
                    ...
                    Card(
                      child: TextFormField(
                        ...
                        validator: (val) {
                          ...
                          if (val.length < 6) {
                            return "Password length must be less then 6";
                          }
                          if (val.length > 10) {
                            return "Password length must be greater then 10";
                          }
                          return null;
                        },
